...
d3.csv("../data/baby_names.csv").then(data => {
    ...
    const pattern = defs.append("pattern")
        ...
        .attr("width", 30) // Adjust width of one repetition of pattern
        .attr("height", 15);

    pattern.append("rect") 
        .attr("width", 30) // width of one repetition of rect fill
        .attr("height", 15)
        .attr("fill", "#ffc107"); // Background color (Bootstrap warning yellow)

    pattern.append("path")
        .attr("d", "M 0,15 L 30,15") // co-ordinates within the repetition, creates horizontal stripes
        .attr("stroke", "#ffe8a4")
        .attr("stroke-width", 2);
